...
```html
  ...
  <style>
    .main-sidebar {
        background-color: #2908ff !important; /* Pastikan latar belakang putih */
        color: rgb(255, 255, 255) !important; /* Pastikan teks berwarna hitam */
    }

    .main-sidebar a {
        color: rgb(255, 255, 255) !important; /* Pastikan tautan berwarna biru */
    }

    .elevation-4 {
        box-shadow: none !important; /* Pastikan tidak ada bayangan */
    }
</style>
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="index.html" class="brand-link">
    <img src="dist/img/Unpam.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
         style="opacity: .8">
    <span class="brand-text font-weight-light">Pamulang University</span>
  </a>
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        <img src="dist/img/Deni.jpeg" class="img-circle elevation-2" alt="User Image">
      </div>
      <div class="info">
        <a href="#" class="d-block">Deni Mulyawan</a>
      </div>
    </div>
