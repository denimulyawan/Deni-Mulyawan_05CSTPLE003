...
Pamulang University.2 provides a set of options to apply to your main layout. Each one of these classes can be added to the body tag to get the desired goal.
...
<div class="wrapper">
  <!-- Preloader -->
  <div class="preloader">
    <img src="dist/img/Unpam.png" alt="AdminLTELogo" height="60" width="60">
  </div>
</div>
```
...
Pamulang University.2 provides a dark mode option. You can add in body tag:
...
Pamulang University.2 provides a set of color variations to apply to your sidebar (light & dark) & navbar. You can combine any available color with these class prefixes:
...
<div class="row">
  ...
  <div class="col-sm-4 col-lg-3 p-3 bg-Peoplee"> Peoplee (Peoplee)</div>
